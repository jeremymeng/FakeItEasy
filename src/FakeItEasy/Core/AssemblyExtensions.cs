    ...
    internal static class AssemblyExtensions
    {
        ...
        public static bool ReferencesFakeItEasy(this Assembly assembly)
        {
            ...
            return context.RuntimeLibraries
                .Where(library => string.Equals(library.Name, assembly.Name(), System.StringComparison.Ordinal))
                .Any(library => library.Dependencies.Any(dependency => string.Equals(dependency.Name, fakeItEasyLibraryName, System.StringComparison.Ordinal)));
#endif
        }
